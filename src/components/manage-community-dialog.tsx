...
import { Settings, Loader2, UploadCloud, UserPlus, Search as SearchIcon, ShieldCheck, ShieldX, Trash2 } from "lucide-react";
...
export function ManageCommunityDialog({ forum, onUpdate, onDelete }: { forum: Forum, onUpdate: (updatedForum: Forum) => void; onDelete: () => void }) {
